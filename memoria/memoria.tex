...
\IfFileExists{figuras/dfd.png}{\includegraphics[width=0.9\textwidth]{figuras/dfd.png}}{%
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.5cm}[Exporta \texttt{docs/threat-model/dfd.mmd} a
\texttt{figuras/dfd.png}]\vspace{1.5cm}}}}
...
T4 & Info. disclosure & AML.T0098 & ASI03 & Broker de credenciales + mínimo privilegio \\
T5 & Info. disclosure & AML.T0098 & ASI03 & Allowlist de egress + filtro de salida \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{table}[h]\centering\small
\caption{ASR por escenario y configuración (éxitos/intentos). Generada por \texttt{make report}.}\label{tab:asr}
\IfFileExists{tablas/asr.tex}{\input{tablas/asr.tex}}{%
\begin{tabular}{lccc}
\toprule
Escenario & C0 & C1 & C2 \\
\midrule
\multicolumn{4}{c}{\emph{Ejecuta \texttt{make report} para generar tablas/asr.tex}} \\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{figure}[h]\centering
\IfFileExists{figuras/asr.png}{\includegraphics[width=0.85\textwidth]{figuras/asr.png}}{%
\fbox{\parbox{0.8\textwidth}{\centering\vspace{1.2cm}[Ejecuta \texttt{make report memoria-figs}]\vspace{1.2cm}}}}
